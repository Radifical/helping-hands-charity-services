...
export const partners = [
  { slug: "rescue-mission-alliance", name: "Rescue Mission Alliance", category: "Housing & Basic Needs", logo: "/partners/rescue-mission-alliance.png", mission: "Rescue Mission Alliance is a Christian nonprofit ministering to the needs of the less fortunate across Southern California through emergency and long-term rehabilitation services, offering a full range of care for the hungry, homeless, and destitute since 1972.", video: { provider: "youtube", id: "P17y96R96f4" } },
  ...
  { slug: "healthebay", name: "Heal the Bay", category: "Environment", logo: "/partners/healthebay.png", mission: "Heal the Bay mobilizes Los Angeles' diverse communities to protect the coastline, restore waterways, and speak out for smart water policy.", video: { provider: "youtube", id: "NO-K5lGq5UM" } },
  ...
  { slug: "illumination-foundation", name: "Illumination Health + Home", category: "Housing & Basic Needs", logo: "/partners/illumination-foundation.png", mission: "Illumination Health + Home disrupts the cycle of homelessness by providing healthcare, housing, and hope together." },
  ...
  { slug: "your-special-day", name: "Voices of Impact", category: "Youth", logo: "/partners/your-special-day.png", logoDark: true, mission: "Voices of Impact (formerly Your Special Day) supports parents and guardians with disabilities and health disadvantages, and empowers their children to thrive." },
  ...
  { slug: "for-goodness-cakes", name: "For Goodness Cakes", category: "Youth", logo: "/partners/for-goodness-cakes.png", mission: "For Goodness Cakes gives youth at least one special moment that is about them, nurturing optimism and confidence with a treat made especially for them." },
  ...
  { slug: "veteran-surf-alliance", name: "Veteran Surf Alliance", category: "Veterans", logo: "/partners/veteran-surf-alliance.webp", logoDark: true, mission: "Veteran Surf Alliance teaches, coaches, and mentors veterans to surf and to become respected members of their communities.", video: { provider: "vimeo", id: "762272387", hash: "c2e4064f61" } },
];
